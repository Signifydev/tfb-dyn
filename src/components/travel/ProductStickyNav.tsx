...
export default function ProductStickyNav() {
  ...
  return (
    <div className="sticky top-[60px] z-[45] w-full border-b border-slate-200/80 bg-white/92 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl md:top-[72px]">
                ...
                <button
                  ...
                  className={`group relative inline-flex shrink-0 items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition-all duration-300 ${
                    isActive
                      ...
                      : 'border-slate-200 bg-white text-slate-600 hover:-translate-y-0.5 hover:border-sky-200 hover:text-slate-950 hover:shadow-md'
                  }`}
                >
                  <Icon
                    className={`h-4 w-4 transition-transform duration-300 ${
                      isActive ? 'scale-100 text-sky-100' : 'text-sky-700 group-hover:scale-110'
                    }`}
                  />
